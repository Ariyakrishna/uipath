...
export let updateEndItemWidgetVisibility = function( data, subPanelContext ) {
    ...
    if( ( locationContext === 'com.siemens.splm.client.occmgmt:OccurrenceManagementSubLocation' || locationContext === 'multiBOMManager:taskPageSubLocation' )  && ( data.flag.dbValue === 'AUTHOR' || data.flag.dbValue === 'AUTHORREVISION' ) ) {
