...
export let updatePropertyDiffMap = ( compareContext, LoadedVMOs ) => {
    ...
    let VMOsToProcess = LoadedVMOs ? LoadedVMOs : Object.keys( sourceVMDiffs );
    ...
    for( let srcIndex = 0; srcIndex < VMOsToProcess.length; srcIndex++ ) {
        let srcKey = VMOsToProcess[srcIndex];
