...
export const getSearchContext = ( searchContext )=>{
    ...
    if( AwStateService.instance.params.uid ) {
        ...
        if( mo ) {
            ...
            searchContext.criteria.searchString = '*';
            searchContext.activeFilterMap['WorkspaceObject.project_list'] = [ {
                searchFilterType: 'StringFilter',
                stringDisplayValue: projId,
                stringValue: projId
            } ];
...
export const getSubPanelContextData = ( provider ) => {
    ...
    return getSearchContext( {} ).then( function( updatedSearchContext ) {
        provider.context.search.criteria = updatedSearchContext.criteria;
        provider.context.search.activeFilterMap = updatedSearchContext.activeFilterMap;
        return provider;
    } );
};
